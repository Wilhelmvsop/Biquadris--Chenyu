...
TEST_CASE(Blocks_Rotation) {
     ...
     auto expectedj1 =
          std::vector<std::pair<int, int>>{{-2, 0}, {-1, 0}, {0, 0}, {-2, 1}};
     auto expectedj2 =
          std::vector<std::pair<int, int>>{{0, 1}, {-1, 1}, {-2, 1}, {0, 0}};
     REQUIRE(expectedj1 == jblock.getRotatedCoords(true));
     REQUIRE(expectedj2 == jblock.getRotatedCoords(false));
     
     auto expectedl1 =
          std::vector<std::pair<int, int>>{{-2, 0}, {-1, 0}, {0, 0}, {0, 1}};
     auto expectedl2 =
          std::vector<std::pair<int, int>>{{0, 1}, {-1, 1}, {-2, 1}, {-2, 0}};
     REQUIRE(expectedl1 == lblock.getRotatedCoords(true));
     REQUIRE(expectedl2 == lblock.getRotatedCoords(false));
     
     auto expectedo1 =
          std::vector<std::pair<int, int>>{{-1, 0}, {0, 0}, {-1, 1}, {0, 1}};
     auto expectedo2 =
          std::vector<std::pair<int, int>>{{0, 1}, {-1, 1}, {0, 0}, {-1, 0}};
     REQUIRE(expectedo1 == oblock.getRotatedCoords(true));
     REQUIRE(expectedo2 == oblock.getRotatedCoords(false));
     
     auto expecteds1 =
          std::vector<std::pair<int, int>>{{-2, 0}, {-1, 0}, {-1, 1}, {0, 1}};
     auto expecteds2 =
          std::vector<std::pair<int, int>>{{0, 1}, {-1, 1}, {-1, 0}, {-2, 0}};
     REQUIRE(expecteds1 == sblock.getRotatedCoords(true));
     REQUIRE(expecteds2 == sblock.getRotatedCoords(false));
     
     auto expectedz1 =
          std::vector<std::pair<int, int>>{{-1, 0}, {0, 0}, {-2, 1}, {-1, 1}};
     auto expectedz2 =
          std::vector<std::pair<int, int>>{{-1, 1}, {-2, 1}, {0, 0}, {-1, 0}};
     REQUIRE(expectedz1 == zblock.getRotatedCoords(true));
     REQUIRE(expectedz2 == zblock.getRotatedCoords(false));
     
     auto expectedt1 =
          std::vector<std::pair<int, int>>{{-1, 0}, {-2, 1}, {-1, 1}, {0, 1}};
     auto expectedt2 =
          std::vector<std::pair<int, int>>{{-1, 1}, {0, 0}, {-1, 0}, {-2, 0}};
...
TEST_CASE(Blocks_Getters_and_Setters) {
     auto expected_i =
          std::vector<std::pair<int, int>>{{0, 0}, {0, 1}, {0, 2}, {0, 3}};
     auto expected_j =
          std::vector<std::pair<int, int>>{{0, 0}, {0, 1}, {0, 2}, {-1, 0}};
     auto expected_l =
          std::vector<std::pair<int, int>>{{0, 0}, {0, 1}, {0, 2}, {-1, 2}};
     auto expected_o =
          std::vector<std::pair<int, int>>{{0, 0}, {0, 1}, {-1, 0}, {-1, 1}};
     auto expected_s =
          std::vector<std::pair<int, int>>{{0, 0}, {0, 1}, {-1, 1}, {-1, 2}};
     auto expected_z =
          std::vector<std::pair<int, int>>{{0, 1}, {0, 2}, {-1, 0}, {-1, 1}};
     auto expected_t =
          std::vector<std::pair<int, int>>{{0, 1}, {-1, 0}, {-1, 1}, {-1, 2}};
