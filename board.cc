...
export class Board {
     ...
     bool updateCurrentBlock(); // true if currentBlock fits on canvas and false otherwise
     ...
     // Setters and getters
     void setCurrentBlock(Block* newBlock); // only called ONCE in the beginning, modifies canvas
