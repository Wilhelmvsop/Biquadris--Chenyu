...
##################################################################
SYSTEM_HEADERS = iostream utility algorithm vector functional stdexcept string
...
MODULE_INTERFACES = math.cc blocks.cc

# List your module implementation files here (same order as interfaces)
MODULE_IMPLS = math-impl.cc blocks-impl.cc
##################################################################
